...
const services = {
  "chimney-animal-removal": {
    title: "Chimney Animal Removal Service",
    title2: "Remove Animals Safely from Your Chimney",
    description: `
      <p>Our professional team provides safe and humane removal of animals from your chimney to prevent damage and ensure safety.</p>
    `,
    description2: `
      <p>Keep your chimney free from unwanted visitors with our expert animal removal services.</p>
    `,
  },
  "chimney-cap-installation": {
    title: "Chimney Cap Installation Service",
  ...
  "local-chimney-sweep-and-cleaning": {
    title: "Local Chimney Sweep and Cleaning Service",
    title2: "Keep Your Chimney Clean and Functional",
    description: `
      <p>We offer thorough cleaning and sweeping of chimneys to prevent blockages and ensure safe operation.</p>
    `,
    description2: `
      <p>Regular chimney cleaning is essential for safety and efficiency. Schedule your cleaning today!</p>
    `,
  },
  "pellet-stove-repair": {
    title: "Pellet Stove Repair Service",
  ...
  "wood-stove-repair": {
    title: "Wood Stove Repair Service",
    title2: "Ensure Your Wood Stove Operates Efficiently",
    description: `
      <p>We provide professional repair services for wood stoves to keep them running safely and efficiently.</p>
    `,
    description2: `
      <p>Don't let a broken stove ruin your warmth. Contact us for expert wood stove repair services.</p>
    `,
  },
};
